...
- `mixin line` inserts before the generated line text.
- `mixin word` inserts before each generated word's source text.
- `mixin syl` inserts before each generated syllable's source text.
- `mixin char` inserts before each generated character's source text.
